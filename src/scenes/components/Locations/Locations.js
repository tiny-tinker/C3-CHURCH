 ...
 * Import images
 */
import defaultLocation from '../../../assets/images/default.jpg';
...
class Locations extends React.Component {
    ...
    if (locations !== null) {
      return locations.map(location => (
        <Col xs="4">
          <LocationTextClip
            handleEventOver={() => {
              this.handleHoverLocation(location.id);
            }}
    ...
    if (locations !== null) {
      return locations.map(location => (
        <LocationClip
          ...
          times={location.times}
          id={location.id}
          backgroundImage={location.photo_url}
        />
      ));
    }
  }
  ...
  render() {
    ...
    // Check if to show the loading visit and decide the class
    ...
    return (
      <div className="locations-component">
        <div className="locations-container">
          ...
          <div
            className="locations-viewer"
            style={{ visibility: loading ? 'hidden' : 'visible' }}
            ref={ref => {
              this.locationViewer = ref;
            }}
          >
            ...
            <div className="locations-data-container">
              <AlignItemCenter className="w-100">
                <Container>
                  <Row>{this.renderLocationTextClip(locations)}</Row>
                </Container>
              </AlignItemCenter>
            </div>
